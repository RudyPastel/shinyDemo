...
clients by building an app that allows users to interact with the data.
...
Among the client suggestions, I picked to the [Tidy Tuesdays](https://www.tidytuesday.com/) 
